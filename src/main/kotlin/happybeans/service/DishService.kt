...
class DishService(
    ...
    @Transactional
    fun updateDish(dishId: Long, updateRequest: DishUpdateRequest): Dish {
        val dish = findById(dishId)
    ...
    @Transactional
    fun patchDish(dishId: Long, patchRequest: DishPatchRequest): Dish {
        val dish = findById(dishId)
    ...
    @Transactional
    fun addDishOption(dishId: Long, optionRequest: DishOptionCreateRequest): DishOption {
        val dish = findById(dishId)
    ...
    @Transactional
    fun updateDishOption(dishId: Long, optionId: Long, updateRequest: DishOptionUpdateRequest): DishOption {
    ...
    @Transactional
    fun patchDishOption(dishId: Long, optionId: Long, patchRequest: DishOptionPatchRequest): DishOption {
        val dishOption = findByIdAndDishOptionId(dishId, optionId)
    ...
    @Transactional
    fun deleteDishOption(dishId: Long, optionId: Long) {
        val dish = findById(dishId)
        val dishOption = findByIdAndDishOptionId(dishId, optionId)
